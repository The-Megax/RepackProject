...
function Jerrikar_Silence(pUnit,Event)
	pUnit:FullCastSpellOnTarget(38913,pUnit:GetClosestPlayer())
end

function Jerrikar_DarkStrike(pUnit,Event)
	pUnit:FullCastSpellOnTarget(38926,pUnit:GetClosestPlayer())
end

function Jerrikar_DiplomaticImmunity(pUnit,Event)
	pUnit:FullCastSpellOnTarget(38916,pUnit:GetClosestPlayer())
end
