...
function Prower_onCombat(unit, event)
	unit:RemoveEvents()
end
...
--// Biletoad
function Biletoad_OnEnterCombat(pUnit,Event)
	pUnit:FullCastSpellOnTarget(10251,pUnit:GetClosestPlayer())
end

RegisterUnitEvent(2835, 1, "Biletoad_OnEnterCombat")

--// Cat
function Cat_OnEnterCombat(pUnit,Event)
	pUnit:FullCastSpellOnTarget(16828,pUnit:GetClosestPlayer())
	pUnit:FullCastSpellOnTarget(14916,pUnit:GetClosestPlayer())
end

RegisterUnitEvent(6368, 1, "Cat_OnEnterCombat")

--// Cow
function Cow_OnDied(pUnit,Event)
	pUnit:SendChatMessage(12, 0, "Moo!")
end

RegisterUnitEvent(2442, 4, "Cow_OnDied")

--// Effsee
function Effsee_OnSpawn(pUnit,Event)
	pUnit:RegisterEvent("Effsee_Meow", 50000, 0)
end

function Effsee_Meow(pUnit,Event)
	pUnit:SendChatMessage(11, 0, "Meow")
end

function Effsee_OnDied(pUnit,Event)
	pUnit:RemoveEvents()
end

function Effsee_OnLeaveCombat(pUnit,Event)
	pUnit:RemoveEvents()
end
...
--// Plagued Insect
function PlaguedInsect_OnEnterCombat(pUnit,Event)
	pUnit:FullCastSpellOnTarget(16460,pUnit:GetClosestPlayer())
end

RegisterUnitEvent(10461, 1, "PlaguedInsect_OnEnterCombat")
--// Plagued Maggot
function PlaguedMaggot_OnEnterCombat(pUnit,Event)
	pUnit:FullCastSpellOnTarget(16449,pUnit:GetClosestPlayer())
end

RegisterUnitEvent(10536, 1, "PlaguedMaggot_OnEnterCombat")
--// Plagued Rat
function PlaguedRat_OnEnterCombat(pUnit,Event)
	pUnit:FullCastSpellOnTarget(16448,pUnit:GetClosestPlayer())
end

RegisterUnitEvent(10441, 1, "PlaguedRat_OnEnterCombat")
--// Sickly Deer
function SicklyDeer_OnSpawn(pUnit,Event)
	pUnit:RegisterEvent("SicklyDeer_Die", 180000, 0)
end

function SicklyDeer_Die(pUnit,Event)
	pUnit:CastSpell(5)
end

function SicklyDeer_OnDied(pUnit,Event)
	pUnit:RemoveEvents()
end

function SicklyDeer_OnLeaveCombat(pUnit,Event)
	pUnit:RemoveEvents()
end

RegisterUnitEvent(12298, 6, "SicklyDeer_OnSpawn")
--// Soot
function Soot_OnSpawn(pUnit,Event)
	pUnit:CastSpell(35112)
end

RegisterUnitEvent(19154, 6, "Soot_OnSpawn")
--// Spider
function Spider_OnEnterCombat(pUnit,Event)
	pUnit:FullCastSpellOnTarget(27138,pUnit:GetClosestPlayer())
end
